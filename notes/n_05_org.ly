...
RedemptionemOrgano = {
	\relative c {
		...
		h h'\fE g e a, a' fis d %375
		g, g' e c a e' h' h,
		e4. fis8\pE g a16 g fis8 a
		h h, dis h e d? c4
		h8 h' g e c h a d
		g, a h c d4 c8 h %380
		a h c h a h c d
		...
		h h'\fE g e a, a' fis d
		g, g' e c a e' h' h,
		e c'\pE a h e, e' c a %390
		d, d' h g c, c' a fis
		h, cis dis h e a h h,
		e e\fE h' h, e4 r\fermata \bar "||" %393 finis
	}
}
...
RedemptionemBassFigures = \figuremode {
	...
	<_+>4 <6> r8 <6> q4
	<_+>4 <6> q8 q r4
	r8 <6> q4 <4>8 <3> <6> <6\\> %380
	r <6\\> <6> <6\\> r q <6> <6 _!>
	<_+>4 <6> r8 <_+>16 <\t> <6>4
	<_!>4 <6 5!>8 <7!> r <6 _!> <6>4
	q <6 4>8 <5 _+> r4. <6>8
	q2. <6>4 %385
	r8 q q q r2
	r8 <6>16 q r8 q r4. q8
	<_+>4 <6> <7> <6>
	<7> <6> q <_+>
	r <6 5>8 <_+> r4 <6 5>8 <7> %390
	r4 <6 5>8 <7> r4 <6 5>8 <7>
	<_+>4 <6> r <_+>
	r q r2 %393 finis
}
...
SanctumOrgano = {
	\relative c {
		...
		g, d' \noBreak
		g, a
		\time 4/4 \tempoSanctumC d4 r d\fE r \noBreak %430
		d r d d\pE
		dis h e4. fis8
		gis4 e a,8 a'\fE a a
		d, g f! g c, d e\pE c
