...
SanctumViolinoII = {
	\relative c' {
		...
		c16\fE d c h a c h a
		h c h a gis h a gis
		a4 r %405
		R2*4
		e'16 f e d c e d c %410
		d e d c h d c h
		c4 r
		R2
		e16 f e d c e d c
		...
		c4 g
		R2*3
		h16 c h a g h a g %420
		a h a g fis a g fis
		g4 r
		R2
		h16 c h a g h a g
		a h a g fis a g fis %425
		g4 d
		R2*3
		\time 4/4 \tempoSanctumC r4 d'8 fis d a fis' a \noBreak %430
		fis d a' d a fis r4
		R1
		r2 r8 c c c
		d h h h c h e4
...
GloriaViolinoII = {
	\relative c' {
		...
		\kneeBeam d16\f fis' e fis d8 e16 fis g4 r
		r r8 a16\p g a4 r %525
		r r8 g16 fis g4 r
		r8 g, d g d4 r8 d
		e4 r8 fis \noBreak
		g c, d8. d16
